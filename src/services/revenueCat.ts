...
// Native (iOS/Android) — App Store / Play Store billing via react-native-purchases.
// Web uses revenueCat.web.ts instead (Metro resolves it automatically for web
// bundles), since the native SDK has no browser support.
