...
**Open bugs:** None — BUG-MOB-024 (resume upload 500 on web) fixed Aug 9, 2026, found from a real user screenshot on the live production site.
**Last push:** Aug 9, 2026 — BUG-MOB-024 fix (ResumeUploadScreen.tsx web multipart file part), on `main`.
