...
**Open bugs:** None
**Last push:** Jul 11, 2026 — `284c1bb` (FEAT-021, resume status gate on JobFeedScreen). BUG-MOB-012 (resume "Use for job matching" selector) pending commit this session.
