...
**Open bugs:** None
**Last push:** Jul 12, 2026 — `73d5b57` (BUG-MOB-012, resume "Use for job matching" selector). BUG-MOB-013 (stale multi-original data made the selector unusable for older accounts) pending commit this session.
